...
RSpec.describe "shared fixture corpus" do
  let(:corpus_root) { File.expand_path("../../../../testdata/shared/manifest", __dir__) }

  it "parses compose-tree-file against expected.json" do
    dir = File.join(corpus_root, "compose-tree-file")
